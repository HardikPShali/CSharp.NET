<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hifloter.aspx.cs" Inherits="InsuranceHub.hifloter" %>
                                           ...
                                           <tr> <strong><P style="font-size:large"><b>Proposer Details</b></P></strong></tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                        ...
                                                        <td><i class="fa fa-rupee"></i><asp:Label ID="isum" runat="server"></asp:Label></td>
                                   ...
                                   <thead>
                                         <strong><tr><P style="font-size:large"><b>Member Details</b></P></tr></strong>
                                                <tr>
                                                    ...
                                                    <th class=col-sm-3>DOB</th>
                                                    <th class=col-sm-3>Relation With Proposer</th>
                                                    <th class=col-sm-3>Sum Insured</th>
                                                </tr>
                                            </thead>
                            ...
                            <ItemTemplate>
                                  <tr>
                                    ...
                                    <i class="fa fa-rupee"></i>
                                     <asp:Label ID="Label1" runat="server" Text='<%# Eval("sum_insured") %>'></asp:Label>
                                    </td>
