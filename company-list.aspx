<%@ Page Title="" Language="C#" MasterPageFile="~/header-footer.Master" AutoEventWireup="true"
    CodeBehind="company-list.aspx.cs" Inherits="InsuranceHub.company_list" %>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="add_company.aspx"> <i class="fa fa-plus"></i> Add Company
                                            </a>  
                                        </div>        
                                    </div>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <asp:updatepanel runat="server" id="up" UpdateMode="Conditional">
                                                                        <contenttemplate>
                                                                        <asp:LinkButton ID="edit" runat="server" class="btn btn-info btn-xs" CommandArgument='<%# Eval("comp_id") %>'
                                                                            OnClick="edit_Click"><i 
                                                                            class="fa fa-pencil"></i></asp:LinkButton>
                                                                            <asp:LinkButton ID="del" runat="server" class="btn btn-danger btn-xs" 
                                                                            CommandArgument='<%# Eval("comp_id") %>' OnClick="del_Click"><i 
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-header">
                     ...
                     <h1 class="modal-title">Update Company</h1>
                  </div>
                  ...
                  <div class="modal-footer">
                     <asp:Button ID="close" class="btn btn-warning" runat="server" Text="Reset" data-dismiss="modal"
                      ...
                      <asp:Button ID="update" OnClick="update_Click" class="btn btn-success" runat="server" Text="Save Changes" CommandArgument='<%# Eval("comp_id") %>'/>
                  </div>
               </div>
            </div>
         </div>
