<%@ Page Title="" Language="C#" MasterPageFile="~/header-footer.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="InsuranceHub.contact" %>
  ...
  <div class="wrapper">
                    <div class="content-wrapper">
                        ...
                        <div class="header-title">
                            ...
                            <h1>Contact Us</h1>
                            <small>Contact Us Details</small>
                                                        ...
                                                        <asp:Repeater ID="rpt" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lbl2" runat="server" Text='<%# Eval("msg") %>'></asp:Label>
                                                                    </td>
