...
{
    public partial class termtodaycollection : System.Web.UI.Page
    {
        ...
        public void fillrpt()
        {
            String qry = "select * from policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where p.policy_id=tp.plan_id and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
        ...
        protected void search_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "select * from  policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where  p.policy_id=tp.plan_id and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and p.policy_no like '" + pno.Text + "%' and tp.mobile like '" + mno.Text + "%' and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
                SqlDataAdapter da = new SqlDataAdapter(query, con);
                cmd = new SqlCommand(query, con);
                dt = new DataTable();
                adp = new SqlDataAdapter(cmd);
            ...
            {
                string q = "select * from policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where p.policy_id=tp.plan_id and p.policy_no like @p and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
            ...
            else if (from.Text != "" && to.Text != "")
            {
                ...
                string query = "select * from policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where p.policy_id=tp.plan_id and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and tb.date >= '" + from.Text.ToString() + "' and tb.date <=  '" + to.Text.ToString() + "' and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
                SqlDataAdapter da = new SqlDataAdapter(query, con);
                cmd = new SqlCommand(query, con);
                dt = new DataTable();
                adp = new SqlDataAdapter(cmd);
            ...
            else if (from.Text != "")
            {
                ...
                string query = "select * from policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where p.policy_id=tp.plan_id and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and tb.date >= '" + from.Text.ToString() + "' and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
                SqlDataAdapter da = new SqlDataAdapter(query, con);
                cmd = new SqlCommand(query, con);
                dt = new DataTable();
                adp = new SqlDataAdapter(cmd);
            ...
            {
                string query = "select * from policy p,terminsu_pi tp,terminsu_ai ta,termbankdetails tb where p.policy_id=tp.plan_id and tp.id=ta.tid and ta.aid=tb.terminsu_ai_id and tp.mobile like '" + mno.Text + "%' and tb.date= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0)";
                SqlDataAdapter da = new SqlDataAdapter(query, con);
                cmd = new SqlCommand(query, con);
                dt = new DataTable();
                adp = new SqlDataAdapter(cmd);
