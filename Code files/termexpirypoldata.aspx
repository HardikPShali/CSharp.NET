<%@ Page Title="" Language="C#" MasterPageFile="~/header-footer.Master" AutoEventWireup="true" CodeBehind="termexpirypoldata.aspx.cs" Inherits="InsuranceHub.termexpirypoldata" %>
...
<div class="wrapper">
   <div class="content-wrapper">
      ...
      <div class="header-title">
         ...
         <h1>Expire Policy Data </h1>
         <small>Expire Policy Data Report</small>
                              ...
                              <fieldset>
                                 <asp:Repeater ID="rpt" runat="server">
                                    ...
                                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("date","{0:MM/dd/yyyy}")  %>'></asp:Label>
                                      ...
                                      <%--  <a href="javascript:window.print()" class="btn btn-info"><span class="fa fa-print"></span></a> --%>
