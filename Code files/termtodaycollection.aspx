<%@ Page Title="" Language="C#" MasterPageFile="~/header-footer.Master" AutoEventWireup="true" CodeBehind="termtodaycollection.aspx.cs" Inherits="InsuranceHub.termtodaycollection" %>
...
<div class="wrapper">
   <div class="content-wrapper">
      ...
      <div class="header-title">
         ...
         <h1>Today's Policy Data </h1>
         <small>Today's Policy Data Report</small>
         <ol class="breadcrumb hidden-xs">
           ...
           <!--filter content-->
               ...
               <asp:LinkButton ID="search" class="btn btn-success" OnClick="search_Click"  runat="server">Filter</asp:LinkButton>
