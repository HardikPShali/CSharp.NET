<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invoice-report.aspx.cs" Inherits="InsuranceHub.invoice_report" %>
                                                ...
                                                <tr>
                                                    <td><div><strong><asp:Label ID="policyname" runat="server"></asp:Label></strong></div></td>
                                                        ...
                                                        <td><i class="fa fa-rupee"></i><asp:Label ID="totalcost" runat="server"></asp:Label></td>
                                                           <td><i class="fa fa-rupee"></i><asp:Label ID="paidcost" runat="server"></asp:Label></td>
                                                           <td><i class="fa fa-rupee"></i><asp:Label ID="rcost" runat="server"></asp:Label></td>
                                                    </tr>
